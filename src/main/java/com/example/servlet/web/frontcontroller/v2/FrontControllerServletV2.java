...
@WebServlet(name = "/frontControllerServletV2", urlPatterns = "/front-controller/v2/*") // /front-controller/v2/* 하위에 뭐가 있던 뭐든지 받는다.
public class FrontControllerServletV2 extends HttpServlet {
    ...
    public FrontControllerServletV2() {
        ...
        controllerMap.put("/front-controller/v2/member/save", new MemberSaveControllerV2());
